...
var pole = [{en:"antelope",cz:"antilopa"},
            ...
            { en: "stunt", cz: "vrcholny vykon, kousek" },
            { en: "released", cz: "rozpusteny, uvolneny" },
            { en: "shrink", cz: "smrsknout se, zcvrknout se" },
            { en: "sold out", cz: "vyprodany" },
            { en: "flattery", cz: "lichoceni, lichotky" },
            { en: "accuse of", cz: "obvinit z" },
            { en: "determination", cz: "odhodlani" },
            { en: "modist", cz: "skromny" },
            { en: "ensure", cz: "zajistit, zarucit" },
            { en: "root", cz: "koren, odmocnina" },
            { en: "highly confidential", cz: "velice duverne" },
            { en: "thrill", cz: "vzruseni, napeti" },
            { en: "profoundly", cz: "nesmirne, hluboce" },
            { en: "ultimately", cz: "konec koncu, nakonec" },
            { en: "nevertheless", cz: "nicmene, avsak" },
            { en: "breathing apparatus", cz: "dychaci pristroj (pod vodu, do koure)" },
            { en: "ointment", cz: "mast" },
            { en: "pool attendant", cz: "plavcik" },
            { en: "checkout", cz: "pokladna" },
            { en: "fine", cz: "pokuta" },
            { en: "customs", cz: "celnice, clo" },
            { en: "lifeboat", cz: "zachranny clun" },
            { en: "below zero", cz: "pod nulou (teplota)" },
            { en: "mild winter", cz: "mirna zima" },
            { en: "weather forecast", cz: "predpoved pocasi" },
            { en: "trunk", cz: "kmen, kufr, chobot" },
            { en: "guide dog", cz: "vodici pes" },
            { en: "breed", cz: "chovat (zvirata)" },
            { en: "reptile", cz: "plaz" },
            { en: "famine", cz: "hladomor" },
            { en: "sit around", cz: "poposedavat, vrtet se na zidli" },
            { en: "sort rubbish", cz: "tridit odpad" },
            { en: "careless", cz: "neopatrny" },
            { en: "late", cz: "zesnuly" },
            { en: "assessment", cz: "posouzeni, ohodnoceni" },
            { en: "overhear", cz: "zaslechnout" },
            { en: "mishear", cz: "preslechnout" },
            { en: "hearing aid", cz: "naslouchatko" },
            { en: "bride", cz: "nevesta" },
            { en: "bridegroom", cz: "zenich" },
            { en: "dairy products", cz: "mlecne vyrobky" },
            { en: "litter", cz: "odpadky (venkovni)" },
            { en: "underpass", cz: "podjezd, podchod" },
            { en: "flyover", cz: "nadjezd" },
            { en: "cope with", cz: "vyrovnat se s (zmenou, ztratou..)" },
            { en: "snow drift", cz: "zavej" },
            { en: "slippery", cz: "kluzke" },
            { en: "black ice", cz: "ledovka" },
            { en: "dignity", cz: "dustojnost" },
            { en: "successor", cz: "naslednik, nastupce" },
            { en: "evidence", cz: "dukaz, svedectvi (uncountable)" },
            { en: "eye witness", cz: "ocity svedek" },
            { en: "plaster", cz: "naplast" },
            { en: "clay", cz: "hlina, jil, antuka" },
            { en: "abseiling", cz: "zlanovani" },
            { en: "in person", cz: "osobne" },
            { en: "carpentry", cz: "tesarina, tesarstvi" },
            { en: "puddle", cz: "kaluz" },
            { en: "break-in", cz: "nasilne vloupani" },
            { en: "fire engine", cz: "hasicske auto" },
            { en: "undercooked", cz: "nedovarene" },
            { en: "seal", cz: "pecet, tulen" },
            { en: "commitment", cz: "zavazek" },
            { en: "suffocate", cz: "udusit se" },
            { en: "ryl", cz: "zito" },
            { en: "grains", cz: "obiloviny" },
            { en: "homeland", cz: "vlast, domovina" },
            { en: "suspension bridge", cz: "visuty most" },
            { en: "overlook", cz: "prehlizet" },
            { en: "stubble", cz: "strniste (na poli, na puse)" },
            { en: "freckle", cz: "pihaty" },
            { en: "throng", cz: "dav, mackanice, tlacenice" },
            { en: "frown", cz: "zamraceny pohled, kabonit se, mracit se" },
            { en: "doorknob", cz: "koule (klika)" },
            { en: "hinges", cz: "panty (dvere)" },
            { en: "vulture", cz: "sup" },
            { en: "freckle", cz: "pihaty" },
            { en: "forgery of documents", cz: "padelani dokumentu" },
            { en: "leeches", cz: "pijavice" },
            { en: "full steam ahead", cz: "plnou parou vpred" },
            { en: "splinter", cz: "triska" },
            { en: "culprit", cz: "pachatel" },
            { en: "occasion", cz: "prilezitost" },
            { en: "commotion", cz: "zmatek" },
            { en: "armful of", cz: "naruc neceho" },
            { en: "out of earshor", cz: "pryc z doslechu, mimo doslech" },
            { en: "dim", cz: "nejasny, kalny, matny, zakalit" },
            { en: "rooster", cz: "kohout" }
]
//hold random integer 
var random = 0;
/*LANGUAGE SELECTION*/
